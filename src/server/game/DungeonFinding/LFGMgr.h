...
typedef std::set<Player*> PlayerPointerSet;
...
class LFGMgr
{
    ...
    public:
        ...
        time_t GetJoinedTime(uint64 guid);
    ...
    private:
        ...
        void GetCompatibleDungeons(LfgDungeonSet& dungeons, const PlayerPointerSet& players, LfgLockPartyMap& lockMap);
