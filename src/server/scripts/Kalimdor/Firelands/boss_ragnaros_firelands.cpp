...
{
    public:
        boss_ragnaros_firelands() :
                CreatureScript("boss_ragnaros_firelands")
        {
        }
        ...
        {
                boss_ragnaros_firelandsAI(Creature* creature) :
                        BossAI(creature, DATA_RAGNAROS), summons(me)
                {
                    ...
                    while (uint32 eventId = events.ExecuteEvent())
                    {
                        switch (eventId)
                        {
                            ...
                            case EVENT_WRATH_OF_RAGNAROS: // Not on tank!
                            {
                                ...
                                SelectTargetList(targets, RAID_MODE<int32>(1, 3, 1, 3), SELECT_TARGET_RANDOM, 200.0f,
                                        true);
                                if (!targets.empty())
                                ...
                                switch (urand(0, 2))
                                {
                                    case 0: // Top
                                    {
                                        splitting = me->SummonCreature(NPC_SPLITTING_BLOW,
                                                SummonPositions[0].GetPositionX(), SummonPositions[0].GetPositionY(),
                                                SummonPositions[0].GetPositionZ(), SummonPositions[0].GetOrientation(),
                                                TEMPSUMMON_CORPSE_DESPAWN, 1000);
                                        for (uint32 x = 0; x < 8; ++x)
                                            me->SummonCreature(NPC_SON_OF_FLAME, HammerEastSummons[x],
                                                    TEMPSUMMON_TIMED_DESPAWN, 57500);
                                    ...
                                    {
                                        splitting = me->SummonCreature(NPC_SPLITTING_BLOW,
                                                SummonPositions[1].GetPositionX(), SummonPositions[1].GetPositionY(),
                                                SummonPositions[1].GetPositionZ(), SummonPositions[1].GetOrientation(),
                                                TEMPSUMMON_CORPSE_DESPAWN, 1000);
                                        for (uint32 x = 0; x < 8; ++x)
                                            me->SummonCreature(NPC_SON_OF_FLAME, HammerMiddleSummons[x],
                                                    TEMPSUMMON_TIMED_DESPAWN, 57500);
                                        me->SetFacingToObject(splitting);
                                        Movement::MoveSplineInit init(me);
                                        init.SetOrientationFixed(true);
                                    ...
                                    {
                                        splitting = me->SummonCreature(NPC_SPLITTING_BLOW,
                                                SummonPositions[2].GetPositionX(), SummonPositions[2].GetPositionY(),
                                                SummonPositions[2].GetPositionZ(), SummonPositions[2].GetOrientation(),
                                                TEMPSUMMON_CORPSE_DESPAWN, 1000);
                                        for (uint32 x = 0; x < 8; ++x)
                                            me->SummonCreature(NPC_SON_OF_FLAME, HammerWestSummons[x],
                                                    TEMPSUMMON_TIMED_DESPAWN, 57500);
                                        me->SetFacingToObject(splitting);
                                        Movement::MoveSplineInit init(me);
                                        init.SetOrientationFixed(true);
                                ...
                                switch (urand(0, 2))
                                {
                                    case 0:
                                        for (uint32 i = 0; i < ENGULFING_FLAME_COUNT; ++i)
                                            me->SummonCreature(NPC_ENGULFING_FLAMES, EngulfingPos[i],
                                                    TEMPSUMMON_CORPSE_DESPAWN, 1000);
                                        break;

                                    case 1:
                                        for (uint32 i = 0; i < ENGULFING_FLAME_COUNT; ++i)
                                            me->SummonCreature(NPC_ENGULFING_FLAMES, EngulfingPos2[i],
                                                    TEMPSUMMON_CORPSE_DESPAWN, 1000);
                                        break;

                                    case 2:
                                        for (uint32 i = 0; i < ENGULFING_FLAME_COUNT; ++i)
                                            me->SummonCreature(NPC_ENGULFING_FLAMES, EngulfingPos3[i],
                                                    TEMPSUMMON_CORPSE_DESPAWN, 1000);
                                        break;
                                }
                            ...
                            case EVENT_WORLD_FLAMES1:
                                ...
                                for (uint32 i = 0; i < ENGULFING_FLAME_COUNT; ++i)
                                    me->SummonCreature(NPC_ENGULFING_FLAMES, EngulfingPos[i], TEMPSUMMON_CORPSE_DESPAWN,
                                            1000);
...
class npc_sulfuras_smash_trigger: public CreatureScript // 53266
{
    public:
        ...
        {
                npc_sulfuras_smash_triggerAI(Creature* creature) :
                        ScriptedAI(creature)
                {
                ...
                void UpdateAI(const uint32 diff)
                {
                    ...
                    {
                        if (Creature* smash1 = me->SummonCreature(NPC_SULFURAS_SMASH, me->GetPositionX() - 5,
                        ...
                        if (Creature* smash2 = me->SummonCreature(NPC_SULFURAS_SMASH, me->GetPositionX(),
                                me->GetPositionY() + 5, me->GetPositionZ(), me->GetOrientation() + 3,
                                TEMPSUMMON_MANUAL_DESPAWN))
                        {
                        ...
                        if (Creature* smash3 = me->SummonCreature(NPC_SULFURAS_SMASH, me->GetPositionX(),
                                me->GetPositionY() - 5, me->GetPositionZ(), me->GetOrientation() - 3,
                                TEMPSUMMON_MANUAL_DESPAWN))
                        {
...
class npc_sulfuras_smash: public CreatureScript // 53268
{
    public:
        ...
        {
                npc_sulfuras_smashAI(Creature* creature) :
                        ScriptedAI(creature)
                {
                    instance = creature->GetInstanceScript();
                    creature->SetFlag(UNIT_FIELD_FLAGS,
                ...
                void UpdateAI(const uint32 diff)
                {
                    ...
                    while (uint32 eventId = events.ExecuteEvent())
                    {
                        ...
                        {
                            case EVENT_SMASH:
                                wave = me->SummonCreature(NPC_LAVA_WAVE, me->GetPositionX(), me->GetPositionY(),
                                        me->GetPositionZ(), me->GetOrientation(), TEMPSUMMON_MANUAL_DESPAWN);
...
class npc_splitting_blow: public CreatureScript
{
    public:
        ...
        {
                npc_splitting_blowAI(Creature* creature) :
                        ScriptedAI(creature)
                {
                    instance = creature->GetInstanceScript();
                    creature->SetFlag(UNIT_FIELD_FLAGS,
                ...
                void UpdateAI(const uint32 diff)
                {
                    if (m_uiDespawnTimer <= diff)
                    {
                        me->SummonCreature(NPC_SULFURAS, me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(),
...
class npc_sulfuras: public CreatureScript
{
    public:
        ...
        {
                npc_sulfurasAI(Creature* creature) :
                        ScriptedAI(creature)
                {
                    instance = creature->GetInstanceScript();
                    creature->SetFlag(UNIT_FIELD_FLAGS,
...
class npc_son_of_flame: public CreatureScript
{
    public:
        ...
        {
                npc_son_of_flameAI(Creature* creature) :
                        ScriptedAI(creature)
                {
                    instance = creature->GetInstanceScript();
                    creature->SetFlag(UNIT_FIELD_FLAGS,
...
class npc_molten_seed: public CreatureScript
{
    public:
        ...
        {
                npc_molten_seedAI(Creature* creature) :
                        ScriptedAI(creature)
                {
                    instance = creature->GetInstanceScript();
                    creature->SetFlag(UNIT_FIELD_FLAGS,
...
class npc_lava_scion: public CreatureScript
{
    public:
        ...
        {
                npc_lava_scionAI(Creature* creature) :
                        ScriptedAI(creature)
                {
                    instance = creature->GetInstanceScript();
...
class npc_molten_elemental: public CreatureScript
{
    public:
        ...
        {
                npc_molten_elementalAI(Creature* creature) :
                        ScriptedAI(creature)
                {
                    instance = creature->GetInstanceScript();
                    if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 0))
...
class npc_engulfing_flames: public CreatureScript
{
    public:
        ...
        {
                npc_engulfing_flamesAI(Creature* creature) :
                        ScriptedAI(creature)
                {
                    instance = creature->GetInstanceScript();
                    creature->SetFlag(UNIT_FIELD_FLAGS,
...
class npc_dreadflame: public CreatureScript
{
    public:
        ...
        {
                npc_dreadflameAI(Creature* creature) :
                        ScriptedAI(creature)
                {
                    instance = creature->GetInstanceScript();
                    creature->SetFlag(UNIT_FIELD_FLAGS,
...
class npc_living_meteor: public CreatureScript
{
    public:
        ...
        {
                npc_living_meteorAI(Creature* creature) :
                        ScriptedAI(creature)
                {
                    instance = creature->GetInstanceScript();
...
{
    public:
        npc_entrapping_roots() :
                CreatureScript("npc_entrapping_roots")
        {
        }
...
class npc_cloudburst: public CreatureScript
{
    public:
        ...
        {
                npc_cloudburstAI(Creature* creature) :
                        ScriptedAI(creature)
                {
                    instance = creature->GetInstanceScript();
                    creature->SetFlag(UNIT_FIELD_FLAGS,
...
class npc_breathoffrost: public CreatureScript
{
    public:
        ...
        {
                npc_breathoffrostAI(Creature* creature) :
                        ScriptedAI(creature)
                {
                    instance = creature->GetInstanceScript();
                    creature->SetFlag(UNIT_FIELD_FLAGS,
...
class npc_heartofragnaros: public CreatureScript
{
    public:
        npc_heartofragnaros() :
                CreatureScript("npc_heartofragnaros")
        {
        }
